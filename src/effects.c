...
/***************************************************************************
* This code added to Broken Shadows and modified for use with Broken       *
* Shadows by Rahl from Rom 2.4 code (I think this can be found in stock    *
* ROM 2.4 releases)                                                        *
***************************************************************************/
...
void cold_effect(void *vo, int level, int dam, int target)
{
    ...
    if (target == TARGET_CHAR) /* whack a character */
    {
        ...
        if (!IS_NPC(victim))
             gain_condition(victim,victim->pcdata->condition[COND_FULL],
                -1 * dam/20);
